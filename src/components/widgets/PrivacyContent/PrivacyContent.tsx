	...
	<>
		...
		<Typography
			variant={ 'p' }>
			{
				...
				'zur Erfüllung seiner Leistungspflichten erforderlich ist und unsere Weisungen ' +
		...
		<Typography
			variant={ 'p' }>
			{
				...
				'Art. 9 Abs. 2 lit. a DSGVO, sofern besondere Datenkategorien nach ' +
				...
				'Art. 49 Abs. 1 lit. a DSGVO. Sofern Sie in die Speicherung von Cookies oder in ' +
				'den Zugriff auf Informationen in Ihr Endgerät (z. B. via Device-Fingerprinting) ' +
				'eingewilligt haben, erfolgt die Datenverarbeitung zusätzlich auf Grundlage von ' +
				'§ 25 Abs. 1 TTDSG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten ' +
				...
				'erfolgen. Über die jeweils im Einzelfall einschlägigen Rechtsgrundlagen wird in ' +
		...
		<Typography
			variant={ 'p' }>
			{
				...
				'erfolgt die Verarbeitung ausschließlich auf Grundlage dieser Einwilligung ' +
		...
		<Typography
			variant={ 'p' }>
			{
				...
				'Font Awesome ist lokal installiert. Eine Verbindung zu Servern von ' +
		...
		<Typography
			variant={ 'p' }>
			{
				'Weitere Informationen zu Font Awesome finden Sie in der Datenschutzerklärung ' +
				'für Font Awesome unter: '
			}
			<Link
		...
		<Typography
			variant={ 'p' }>
			{
				'Ihre personenbezogenen Daten werden von Cloudflare so lange gespeichert, wie es ' +
				'für die beschriebenen Zwecke erforderlich ist.'
			}
		</Typography>
		<Typography
			variant={ 'p' }>
			...
			<Link
				href={
					'https://opr.vc/docs/cdn/cloudflare/https%3A%2F%2Fwww.cloudflare.com%2F' +
					'resources%2Fassets%2Fslt3lc6tev37%2F1M1j5uuFDuLTYiZJJDPBag%2F770322411' +
					'bcac7f8bcc350e31b1e8319%2FCustomer_DPA_v.3_1_-_de-de_19_Oct_2020.pdf'
				}
				target={ '_blank' }
				rel={ 'noopener noreferrer' }>
				{ 'Cloudflare DPA' }
		...
		<Typography
			variant={ 'p' }>
			{
				...
				'umgesetzt. Diese gelten für alle weltweiten Aktivitäten, bei denen Cloudflare ' +
